"""Service-to-service authentication — same HMAC bearer-token scheme as
dlp-service/app/auth.py, so admin-api's extractclient reuses the exact token
format and admin-api doesn't need a second minting path.
